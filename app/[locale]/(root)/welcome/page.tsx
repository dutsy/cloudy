  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-6 text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="relative">
        ...
        <div className="relative h-28 w-28 bg-emerald-50 border border-emerald-200 dark:bg-emerald-950/30 dark:border-blue-500/20 rounded-[40px] flex items-center justify-center text-blue-600 dark:text-emerald-400 shadow-2xl">
