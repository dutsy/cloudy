...
import { MonthYearPicker } from './MonthYearPicker'; // Assuming this is in the same folder

export default function PopularClient({ initialData }) {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {/* Chart */}
      <div className="h-[500px] w-full bg-white p-6 border rounded-2xl">
